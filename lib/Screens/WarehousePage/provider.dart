...
final warehousePage_data = FutureProvider(
  (ref) {
...
final warehouseitemdata = FutureProvider(
  (ref) {
    int id = ref.watch(warehouseid);
...
final filterProvider = StateProvider.autoDispose<int>((ref) => 2);

final warehouseid = StateProvider(
  (ref) => -1,
);
